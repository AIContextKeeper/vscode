...
1. Select and copy any AI response — from a browser chat or terminal
2. ContextKeeper detects it automatically and prompts you to save
3. Click **Save** and your conversation is stored at [contextkeeper.dev](https://contextkeeper.dev)
...
- **Browser**: Claude.ai, ChatGPT, Gemini, GitHub Copilot Chat
- **Terminal**: Claude Code CLI, aider, Copilot CLI, and any AI tool output
